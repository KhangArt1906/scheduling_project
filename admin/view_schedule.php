...
<div class="modal-footer display">
    <div class="row">
        <div class="col-md-12">
            ...
            <button class="btn float-right btn-danger mr-2" type="button" data-id="<?php echo $id ?>"
                id="delete_schedule">Delete</button>
